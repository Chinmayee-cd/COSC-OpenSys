...
const Home = () => {
	...
	const event5 = events.find(item => item.id === 'event-5');
	...
	return (
		<Helmet title={"Home"}>
			...
			<motion.section
				...
				<h1 className=" h1contactmobile mb-0 glowing-underline h1events">Events</h1>
	...
	<motion.div>
      <div className="events">
        <span className="glowing-underline h1events h1contactmobile">Contact Information</span>
        <div className="where_when contactboxes">
          <div className="contactbox events">
            <div className="mt-2 mb-2">
              <p><i class="ri-map-pin-fill"></i></p>
            </div>
            <div className="events text-center pl-5 pr-5">
              <h3 className="font-bold text-xl mb-3">Location</h3>
              <p>Chaitanya Bharathi Institute of Technology, Gandipet, Hyderabad - 500075.</p>
            </div>
          </div>

          <div className="contactbox events">
            <div className="mt-2 mb-2">
              <p><i class="ri-link-m"></i></p>
            </div>
            <div className="events text-center pl-5 pr-5">
          ...
          <div className="contactbox events">
            ...
            <div className="events text-center pl-5 pr-5">
              ...
              <p className="font-bold">Sai Kiran:+91 7995166572</p>
              <p className="font-bold mt-2">Akil: +91 9442621187</p>
            </div>
          </div>
        </div>
        <style jsx>
