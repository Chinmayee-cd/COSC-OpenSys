          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero_content">
                ...
                <p>A grand symphony of expansive technical spectacles!</p>
      ...
      <section id="about" className="about">
        <div className="abouts">
          ...
          <div className="aboutdescription">
            <Col lg="6">
              <p>
                OpenSys is an amalgamation of multiple events that are designed
                to give you the best competitive experience all while being fun
                and enjoyable. Since we are the open source community of CBIT,
                all the events will be completely free for everyone to
                participate and you also stand a chance to win exciting cash
      ...
      <section id="events" className="events">
        ...
        <div className="neomorphism">
          <div className="containeron">
            <h1>Git Cryptex</h1>
            <p>
              An event aimed to test participants' knowledge on open-source
              technologies such as Git and GitHub. The event comprises two
              stages. First, all the teams will be required to solve a crossword
              puzzle based on open-source technologies. After completing the
              crossword, based on the answers obtained, the teams must commit or
              push the files listed in the crossword answers to COSC’s GitHub
              repository.
            </p>
        ...
        <div className="neomorphism">
          ...
          <div className="containeron">
            ...
            <p>
              An open-sourced event for all the design and UI/UX enthusiasts of
              the college community, who will compete against each other to
              create CSS templates that match the specified pattern.
            </p>
            <div className="display-flex icon-text">
            ...
            <div className="display-flex icon-text">
              ...
              <p>
                Reference Link: <a href="https://cssbattle.dev/">CSS Battle</a>
              </p>
            </div>
